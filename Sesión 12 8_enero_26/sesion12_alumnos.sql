...
-- TODO:
-- DELETE FROM clientes_datos WHERE email = '...';

-- 14) COMPRUEBA:
--     a) que ya no está en clientes_datos
--     b) que sigue en clientes_backup
-- TODO:
-- SELECT * FROM clientes_datos WHERE email = '...';
-- SELECT * FROM clientes_backup WHERE email = '...';

/* =========================================================
   FIN - MODO ALUMNADO
   Entrega: capturas de (1) vista global, (2) vista completa, (3) comprobación backup
   ========================================================= */
